...
public class MOOD950435SearchForMobileApp {
  ...
  @Test
  public void testMOOD950435SearchForMobileApp() throws Exception {
    driver.get("https://www.google.com/");
    driver.findElement(By.name("q")).click();
    driver.findElement(By.name("q")).clear();
    driver.findElement(By.name("q")).sendKeys("mobile App");
